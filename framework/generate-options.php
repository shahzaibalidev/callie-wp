...
<h2><a href="#" target="_blank">Support Forum</a></h2>
</div>
</div>
...
<input name="publish" class="dt_button button button-primary button-large" type="submit" value="Save Changes" id="publish" />
...
<div class="dt_footer">
<input name="save" class="dt_button button button-primary button-large" type="submit" value="Save Changes" />
<div class="saveResult"></div>
</div>
</div> 
...
<span class="upload acera_upload acera-button-blue" id="<?php echo $value['id']; ?>">Upload</span>
<?php if (get_option($value['id'])): ?>
<span type="button" class="acera_remove acera-button" id="remove_<?php echo $value['id']; ?>">Remove</span>
<?php endif; ?>
