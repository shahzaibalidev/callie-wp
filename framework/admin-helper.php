...
<link rel="stylesheet" href="<?php echo get_template_directory_uri()."/framework/"; ?>css/acera_css.css" />
<link rel="stylesheet" href="<?php echo get_template_directory_uri()."/framework/"; ?>css/colorpicker.css" />
<link rel="stylesheet" href="<?php echo get_template_directory_uri()."/framework/"; ?>css/custom_style.css" />
<script type="text/javascript" src="<?php echo get_template_directory_uri()."/framework/"; ?>js/colorpicker.js"></script>
<script type="text/javascript" src="<?php echo get_template_directory_uri()."/framework/"; ?>js/ajaxupload.js"></script>
<script type="text/javascript" src="<?php echo get_template_directory_uri()."/framework/"; ?>js/mainJs.js"></script>
        <?php
		}
    }
}
