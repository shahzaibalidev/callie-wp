<?php
	...
	function callie_style(){
		...
		/*CSS End*/
		/*JS Start*/
		wp_enqueue_script('jquery_min_js', get_template_directory_uri().'/js/jquery.min.js', array(), '1.0', true);
		wp_enqueue_script('bootstrap_min_js', get_template_directory_uri().'/js/bootstrap.min.js', array(), '1.0', true);
		wp_enqueue_script('jquery_stellar_min_js', get_template_directory_uri().'/js/jquery.stellar.min.js', array(), '1.0', true);
