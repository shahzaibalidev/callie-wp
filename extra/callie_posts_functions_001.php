...
function posts_section($selectedtype, $selectedpostnumber = '', $selectedcategory = ''){
	switch ($selectedtype) {
		case 'hotbox':
			if(!$selectedpostnumber || (!is_int($selectedpostnumber) && ($selectedpostnumber <= 0) || ($selectedpostnumber >= 3))){$selectedpostnumber = 3;}
			hotposts_section(''.$selectedpostnumber.'', ''.$selectedcategory.'');
			break;
		
		case 'largebox':
			if(!$selectedpostnumber || (!is_int($selectedpostnumber) && ($selectedpostnumber <= 0))){$selectedpostnumber = 4;}
			largeboxposts_section(''.$selectedpostnumber.'', ''.$selectedcategory.'');
			break;

		case 'smallbox':
			if(!$selectedpostnumber || (!is_int($selectedpostnumber) && ($selectedpostnumber <= 0))){$selectedpostnumber = 3;}
			smallboxposts_section(''.$selectedpostnumber.'', ''.$selectedcategory.'');
			break;

		case 'listbox':
			if(!$selectedpostnumber || (!is_int($selectedpostnumber) && ($selectedpostnumber <= 0))){$selectedpostnumber = 5;}
